...
class StudentsListResource(Resource):
    ...
    def get(self) -> Response | tuple[dict, int]:
        ...
        try:
            ...
            logger.error(f"An error occurred while retrieving a List of student: {ex}")
            return {'error': 'An error occurred while retrieving a List of student'}, 500
...
class StudentResource(Resource):
    ...
    def get(self, id: int) -> Response | tuple[dict, int]:
        ...
        try:
            ...
            logger.error(f"An error occurred while retrieving a student: {e}")
            return {'error': 'An error occurred while retrieving a student'}, 500
    ...
    def delete(self, id: int) -> tuple[dict, int]:
        ...
        try:
            ...
            logger.error(f"An error occurred while deleting a student: {ex}")
            return {'error': 'An error occurred while deleting a student'}, 500
...
class CreateStudentResource(Resource):
    ...
    def post(self: RequestBody) -> tuple[dict, int]:
        ...
        try:
            ...
            logger.error(f"An error occurred while create a new student: {exc}")
            return {'error': 'An error occurred while create a new student'}, 500
